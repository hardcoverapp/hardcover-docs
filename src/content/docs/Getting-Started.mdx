...
- <Badge text="Dec 2024" variant="success" /> The following queries are disabled:
    ...
    - `_nsimilar`
    - `_similar`
- <Badge text="Jan 2025" variant="tip" /> have a max timeout of 30 seconds.
- <Badge text="Feb 2025" variant="caution" />have a maximum depth of 3.
- <Badge text="Feb 2025" variant="caution" /> are limited to your own user data, public data, and user data of users you follow.
