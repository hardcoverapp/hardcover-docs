...
import longTitleExample from "src/content/images/librarians/long-title-example.png";
...
```md
<Image src={longTitleExample} alt="Esempio di un titolo lungo su Hardcover" />
```
