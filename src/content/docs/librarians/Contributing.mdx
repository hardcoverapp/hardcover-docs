...
- Reporting Issues: Report any issues you encounter with the documentation site. [Create an Issue](https://github.com/hardcoverapp/hardcover-docs/issues/new?assignees=&labels=&projects=&template=bug_report.md&title=)
- Feature Requests: Share your ideas for new features or improvements to the documentation site. [Suggest a Feature](https://github.com/hardcoverapp/hardcover-docs/issues/new?assignees=&labels=&projects=&template=feature_request.md&title=)
...
or by joining the [Hardcover Discord](https://discord.gg/edGpYN8ym8) and asking for suggestions in the [#API](https://discord.com/channels/835558721115389962/1278040045324075050) or [#librarians](https://discord.com/channels/835558721115389962/1105918193022812282) channels.
...
### Adding a New Page
1. Navigate to the [Hardcover Docs GitHub repository](https://github.com/hardcoverapp/hardcover-docs/)
...
15. Notify the Hardcover team, namely `@revelry` in the [Hardcover Discord](https://discord.gg/edGpYN8ym8) that you have submitted a pull request.
...
12. Notify the Hardcover team, namely `@revelry` in the [Hardcover Discord](https://discord.gg/edGpYN8ym8) that you have submitted a pull request.
...
11. Notify the Hardcover team, namely `@revelry` in the [Hardcover Discord](https://discord.gg/edGpYN8ym8) that you have submitted a pull request.
...
If you are interested in contributing translations, please reach out to the Hardcover team in the [#API](https://discord.com/channels/835558721115389962/1278040045324075050)
or [#librarians](https://discord.com/channels/835558721115389962/1105918193022812282) channels on the [Hardcover Discord](https://discord.gg/edGpYN8ym8).
