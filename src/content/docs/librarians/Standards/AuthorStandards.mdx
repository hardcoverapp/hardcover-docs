...
### Case Sensitivity
Typically, we follow proper noun conventions when capitalizing author names (e.g. Truman Capote). For some authors, deliberate and unconventional capitalization may be used. 

Where that choice is made intentionally and consistently across their books, we should respect that formatting on Hardcover. Their preference takes precedence over standardization to keep Hardcover aligned with authorial intent.

Notable Examples:
- [bell hooks](https://nmaahc.si.edu/explore/stories/bell-hooks#:~:text=As%20she%20pursued%20writing%2C%20she,rather%20than%20toward%20her%20identity.)
...
If an author does not use a headshot anywhere on our list of [acceptable sources](#sourcing-biographical-information), but rather a logo, avatar, or other image, that is acceptable as well. The image should still be high quality and appropriate for a professional context. Avoid images depicting text, book covers, or other non-personal imagery.
