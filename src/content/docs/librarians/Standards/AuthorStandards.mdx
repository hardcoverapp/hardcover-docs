...
If an author does not use a headshot anywhere on our list of [acceptable sources](#sourcing-biographical-information), but rather a logo or other image, that is acceptable as well. The image should still be high quality and appropriate for a professional context. Avoid images depicting text, book covers, or other non-personal imagery.
