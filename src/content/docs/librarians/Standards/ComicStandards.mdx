...
:::note
The following standards are a first draft intended to provide a framework for new librarians and general consistency, and as a result, are subject to change. They may also not be applicable in all situations. If you believe a particular work does not fit into these standards or have suggestions for improvement, please let us know in the <a href={URLS.LIBRARIAN_DISCORD} target="_blank" rel="noreferrer noopener">#librarians</a> Discord channel.
:::
