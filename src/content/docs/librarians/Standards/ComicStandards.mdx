...
<Aside type="notice">
    The following standards are a first draft intended to provide a framework for new librarians and general consistency, and as a result, are subject to change. They may also not be applicable in all situations. If you believe a particular work does not fit into these standards or have suggestions for improvement, please let us know in the Librarians discord channel.
</Aside>
...
Collections of works (such as TBPs for series released as issues and all other collections) should be marked as a "Compilation" with the contained issues added. The collections should be added as a "Featured" series of that format of work but not to any of the series of the books comprising the collection.

    Example: The Sandman: Book Two would be added as the second item in "The Sandman (Books)" but not to "The Sandman" or "Vertigo: Winder's Edge". 
