...
* <a href="https://search.worldcat.org/" target="_blank" rel="noreferrer noopener">WorldCat</a>: WorldCat will often include an edition's physical description, including its page count and country of publication. Front-matter pages numbered with Roman numerals are also often listed separately from the main pagination sequence.
...
Of note, audiobooks have different ASIN's on `Audible.com` vs. `Amazon.com`.
