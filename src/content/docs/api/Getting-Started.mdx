...
import graphqlAuthorizationHeader from 'src/content/images/api/getting-started/graphql-authorization-header.png';
import graphqlExplorerTokenField from 'src/content/images/api/getting-started/graphql-explorer-token-field.png';
...
<Image src={graphqlAuthorizationHeader} alt="Example of the authorization header" />
...
<Image src={graphqlExplorerTokenField} alt="Showing the location of the Authorization Token field in the GraphQL Explorer" />
