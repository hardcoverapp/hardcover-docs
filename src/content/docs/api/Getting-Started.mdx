...
You will be taken to a screen where you can make a token, for this guide you can give the token the `all` scope, give it a short expiration time and give it a name so you will know in the future what you used it for.
...
You will then be given your new API token, make sure to copy it, since you won't see it again once you leave the page.
...
<Aside>
    API tokens are not meant to be shared and should be kept private, especially with the all scope they can be used to access your account and data, if a token is ever compromised you can revoke it.

    And unless you are makign a script or a simple tool for yourself, and you want to make an application that other people can use; then it is recommended to use OAuth,
    TODO: link to guide
</Aside>
