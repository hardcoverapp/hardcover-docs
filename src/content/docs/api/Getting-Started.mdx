...
After you click "Create Key" make sure to copy your new token, since you won't see it again once you leave the page.

<ImageComponent imagePath="/src/content/images/api/getting-started/new_token_message.png" description="The box that appears when you create a new API token." />

<Aside>
    API tokens are not meant to be shared and should be kept private, especially with the `all` scope they can be used to access your account and data, if a token is ever compromised you should immediately revoke it.
