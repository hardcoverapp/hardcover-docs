...
## Getting an API Key
You can get your API token from <a href={URLS.API_KEY} target="_blank" rel="noreferrer noopener">Hardcover's Account API</a> page (also accessible via the Settings menu);
