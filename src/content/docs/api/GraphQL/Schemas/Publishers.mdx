...
title: Publishers
category: reference
lastUpdated: 2026-02-09 18:30:00
...
<table>
    ...
    <tr>
        <td>canonical_id</td>
        <td>Int</td>
        <td>Canonical publisher if duplicate</td>
    </tr>
    <tr>
        <td>created_at</td>
        <td>timestamp!</td>
    ...
    <tr>
        <td>editions</td>
        <td>[editions!]!</td>
        <td>Editions from this publisher</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>object_type</td>
        <td>String!</td>
        <td>Always 'Publisher'</td>
    </tr>
    <tr>
        <td>parent_id</td>
        <td>Int</td>
        <td>Parent publisher (for imprints)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>state</td>
        <td>String!</td>
        <td>Record state (active, duplicate, locked)</td>
    </tr>
    <tr>
        <td>updated_at</td>
        <td>timestamp!</td>
