...
<table>
    ...
    <tr>
        <td>contributions</td>
        <td>[contributions!]!</td>
        <td>Contributors to this edition</td>
    </tr>
    <tr>
        <td>country</td>
        <td>countries</td>
    ...
    <tr>
        <td>images</td>
        <td>[images!]!</td>
        <td>Edition images and covers</td>
    </tr>
    <tr>
        <td>isbn_10</td>
        <td>String</td>
    ...
    <tr>
        <td>isbn_10_valid</td>
        <td>Boolean</td>
        <td>Whether the ISBN-10 is a valid number</td>
    </tr>
    <tr>
        <td>isbn_13</td>
        <td>String</td>
    ...
    <tr>
        <td>isbn_13_valid</td>
        <td>Boolean</td>
        <td>Whether the ISBN-13 is a valid number</td>
    </tr>
    <tr>
        <td>isbns_match</td>
        <td>Boolean</td>
        <td>Whether the ISBN-10 and ISBN-13 point to the same edition</td>
    </tr>
    <tr>
        <td>language</td>
        <td>languages</td>
    ...
    <tr>
        <td>list_books</td>
        <td>[list_books!]!</td>
        <td>List entries containing this edition</td>
    </tr>
    <tr>
        <td>lists_count</td>
        <td>Int!</td>
