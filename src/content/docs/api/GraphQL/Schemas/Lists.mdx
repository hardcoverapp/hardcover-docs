...
**Note:** The list must be public or owned by the authenticated user.
...
**Note:** This mutation needs further testing.
...
**Note:** You can only add books to lists you own. Position may need to be set separately.
