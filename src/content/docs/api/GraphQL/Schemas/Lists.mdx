...
<table>
    ...
    <tr>
        <td>default_view</td>
        <td>String!</td>
        <td>The default view mode for the list</td>
    </tr>
    <tr>
        <td>description</td>
        <td>String</td>
    ...
    <tr>
        <td>featured</td>
        <td>Boolean!</td>
        <td>Whether the list is featured by Hardcover</td>
    </tr>
    <tr>
        <td>featured_profile</td>
        <td>Boolean!</td>
        <td>Whether the list is featured on the user's profile</td>
    </tr>
    <tr>
        <td>followers_count</td>
        <td>Int</td>
        <td>Number of users following this list</td>
    </tr>
    <tr>
        <td>id</td>
        <td>Int!</td>
    ...
    <tr>
        <td>imported</td>
        <td>Boolean!</td>
        <td>Whether the list was imported from another platform</td>
    </tr>
    <tr>
        <td>likes_count</td>
        <td>Int!</td>
    ...
    <tr>
        ...
        <td>An object relationship - the privacy setting details</td>
    </tr>
    <tr>
        <td>privacy_setting_id</td>
        <td>Int!</td>
        <td>Privacy setting ID: 1 = public, 2 = followers only, 3 = private</td>
    </tr>
    <tr>
        <td>public</td>
        <td>Boolean!</td>
    ...
    <tr>
        <td>ranked</td>
        <td>Boolean!</td>
        <td>Whether the list items are ranked/ordered</td>
    </tr>
    <tr>
        <td>slug</td>
        <td>String</td>
    ...
    <tr>
        <td>url</td>
        <td>String</td>
        <td>The URL for the list</td>
    </tr>
    <tr>
        <td>user</td>
        <td>users!</td>
        <td>An object relationship - the user who created the list</td>
    </tr>
    <tr>
        <td>user_id</td>
        <td>Int!</td>
