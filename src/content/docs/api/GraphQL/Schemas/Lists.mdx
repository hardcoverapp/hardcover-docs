...
<table>
    ...
    <tr>
        ...
        <td>Boolean!</td>
        <td>Featured on profile</td>
    </tr>
    <tr>
        <td>followed_lists</td>
        <td>[followed_lists!]!</td>
        <td>Follow entries for this list</td>
    </tr>
    <tr>
        <td>followers</td>
        <td>[followed_users!]!</td>
        <td>Users following this list</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>ranked</td>
        <td>Boolean!</td>
        <td>Books are ranked/ordered</td>
    </tr>
    <tr>
        <td>slug</td>
        <td>String</td>
