...
<table>
    ...
    <tr>
        ...
        <td>Int!</td>
        <td>Book or edition ID</td>
    </tr>
    <tr>
        <td>contributable_type</td>
        <td>String!</td>
        <td>Type (Book, Edition)</td>
    </tr>
    <tr>
        <td>contribution</td>
        <td>String</td>
        <td>Role (author, illustrator, translator, etc.)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>contributor_role_id</td>
        <td>Int</td>
        <td></td>
    </tr>
    <tr>
        <td>contributor_role_specialization</td>
        <td>contributor_role_specializations</td>
        <td>An object relationship</td>
    </tr>
    <tr>
        <td>contributor_specialization</td>
        <td>contributor_specializations</td>
        <td>An object relationship</td>
    </tr>
    <tr>
        <td>contributor_specialization_id</td>
        <td>Int</td>
        <td></td>
    </tr>
    <tr>
