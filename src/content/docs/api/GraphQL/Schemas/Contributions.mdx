...
<table>
    ...
    <tr>
        <td>author_id</td>
        <td>Int!</td>
        <td>ID of the author making the contribution</td>
    </tr>
    <tr>
        <td>book</td>
        <td>books</td>
    ...
    <tr>
        ...
        <td>Int!</td>
        <td>ID of the entity receiving the contribution (book or edition)</td>
    </tr>
    <tr>
        <td>contributable_type</td>
        <td>String!</td>
        <td>Type of entity receiving the contribution (e.g., "Book", "Edition")</td>
    </tr>
    <tr>
        <td>contribution</td>
        <td>String</td>
        <td>Type of contribution (e.g., "Author", "Illustrator", "Translator")</td>
    </tr>
    <tr>
        <td>created_at</td>
        <td>timestamp!</td>
        <td>Timestamp when the contribution record was created</td>
    </tr>
    <tr>
        <td>id</td>
        <td>bigint!</td>
    ...
    <tr>
        <td>updated_at</td>
        <td>timestamp!</td>
        <td>Timestamp of the last update to the contribution record</td>
    </tr>
    </tbody>
</table>
